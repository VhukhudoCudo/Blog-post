...
// MongoDB connection (use environment variable if possible)
mongoose.connect(
  process.env.MONGO_URI || 'mongodb+srv://sharonrosesiyanata7:VICEgDztKhvISLKu@cleanblogpost.q79mm.mongodb.net/blog_db',
